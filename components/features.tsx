...
const defaultContent: FeaturesContent = {
  ...
  subtitle: "Discover our unique approach to AI-powered brand content",
}
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="hidden md:block liquid-glass border border-white/10 bg-white/5 backdrop-blur-xl">
          <CardHeader>
            ...
            <CardTitle className="mt-1 text-xl text-white">Generate content that feels unique and on-brand</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div className="relative aspect-[3/4] overflow-hidden rounded-xl border border-white/10">
                <Image
                  ...
                  alt="AI-generated campaign visual with brand styling"
                  fill
              ...
              <div className="relative aspect-[3/4] overflow-hidden rounded-xl border border-white/10">
                <Image
                  ...
                  alt="AI-generated product shot with custom aesthetics"
                  fill
                  className="object-cover"
                  sizes="(min-width: 768px) 240px, 45vw"
                  priority={false}
        ...
        <Card className="liquid-glass border border-white/10 bg-white/5 backdrop-blur-xl">
          <CardHeader>
            ...
            <CardTitle className="mt-1 text-xl text-white">
              Allok's AI visuals didn't just look amazing — they boosted our engagement overnight.
            </CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Image
                ...
                width={280}
                height={160}
                alt="AI-generated brand mockup concepts"
              ...
              <Image
                ...
                width={280}
                height={160}
                alt="AI-generated campaign visuals in action"
                className="h-full w-full rounded-xl border border-white/10 object-cover"
              />
            </div>
          </CardContent>
