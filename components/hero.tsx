      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center py-14 sm:py-20">
          ...
          <h1 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            ...
            <span className="block text-lime-300 drop-shadow-[0_0_20px_rgba(132,204,22,0.35)]">FOR BRANDS</span>
          </h1>
          <p className="mt-4 text-center text-base text-neutral-300 sm:text-lg max-w-2xl">
            Create stunning images and videos with AI to make your brand unforgettable.
          </p>
...
const phoneData = [
  {
    title: "Conversions",
    sub: "Turn clicks into paying customers with scroll-stopping visuals.",
    tone: "results",
  ...
  {
    title: "Speed",
    sub: "Create brand-ready content in minutes, not weeks.",
    tone: "speed",
    gradient: "from-[#0b1a0b] via-[#052e16] to-[#022c22]",
  },
  {
    title: "Social",
    sub: "Made for Instagram, TikTok, YouTube, and more.",
    tone: "social",
