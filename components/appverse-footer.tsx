...
const defaultContent: FooterContent = {
  tagline:
    "Experience AI-powered image & video creation like never before. We craft bold visuals for brands that want to stand out.",
          ...
          <div className="relative grid items-center gap-8 md:grid-cols-2">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold leading-tight text-white sm:text-3xl">
                Preview &amp; approve visuals from anywhere
              </h3>
              <p className="mt-2 max-w-prose text-sm text-neutral-400">
                Review assets, leave feedback, and publish instantly. From feedback to publish in a single flow — zero
                hassle.
              </p>
            </div>
              ...
              <div className="relative rounded-[28px] liquid-glass p-2 shadow-2xl">
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <LazyVideo
                    ...
                    muted={true}
                    playsInline={true}
                    aria-label="Allok app preview - approvals made easy"
                  />
                  {/* On-screen content */}
                  <div className="relative p-3">
                    ...
                    <div className="space-y-1 px-1">
                      ...
                      <p className="text-xs text-white/80">From feedback to publish in a single flow</p>
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                <Image src="/icons/skitbit-white.svg" alt="Allok logo" width={24} height={24} className="h-6 w-6" />
                <span className="text-xl font-semibold text-lime-300">Allok</span>
              </div>
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      aria-label="Follow Allok on Twitter"
                    >
                      X/Twitter
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Subscribe to Allok on YouTube"
                    >
                      YouTube
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Allok on Instagram"
                    >
                      Instagram
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Allok on Threads"
                    >
                      Threads
                    </a>
                  </li>
