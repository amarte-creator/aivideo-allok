      ...
      <div className="container mx-auto px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-2 max-w-xl text-sm text-neutral-400" itemProp="description">
            No hidden fees. Just world-class AI-powered visuals that fit your budget.
          </p>
          <div className="mt-6">
            <Button
              asChild
            ...
            >
              <Link href="https://wa.me/584220023684" target="_blank">
                Contact now
              </Link>
            </Button>
          </div>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          ...
          >
            ...
            <CardHeader className="space-y-3 pb-4">
              ...
              <div className="flex items-end gap-2 text-neutral-100">
                ...
                <span className="pb-0.5 text-[11px] text-neutral-400">per package</span>
          ...
          >
            ...
            <CardContent className="pt-0">
              <ul className="grid gap-2" itemProp="description">
                {["25 images or 5 video ads", "2 revisions", "Delivered in 2 weeks", "Campaign-ready visuals"].map(
                  (f, i) => (
                    <FeatureItem key={i} text={f} />
                  ),
                )}
