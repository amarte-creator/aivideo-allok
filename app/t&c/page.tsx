...
export const metadata: Metadata = {
  title: "Terms and Conditions — Allok",
  description: "Terms and conditions for Allok AI content creation services.",
  robots: {
    index: false,
    follow: false,
    noarchive: true,
              ...
              <div className="relative space-y-12">
                <header className="space-y-4">
                  ...
                  <p className="text-neutral-400 text-lg">
                    Welcome to Allok. By accessing our website, you agree to these terms and conditions. Please read
                    them carefully.
                  </p>
                </header>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    These Terms and Conditions govern your use of the Allok website and services. By using our website,
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Unless otherwise stated, Allok owns all the project files. This includes all electronic files,
                    AI-generated assets, source files, and any materials provided to the client, which remain the sole
                    property of Allok, even if shared.
                  </p>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Allok will not be liable for any direct, indirect, or consequential loss or damage arising under
