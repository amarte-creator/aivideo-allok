...
const defaultContent: ContentData = {
  hero: {
    title: "AI ART FOR BRANDS",
    subtitle: "allok.fun",
    buttonText: "Chat With Us",
  },
  features: {
    title: "What makes us the best studio for you.",
    subtitle: "Discover our unique approach to AI-powered content creation",
  },
  footer: {
    tagline:
      "Experience AI-powered brand content like never before. We craft stunning visuals for brands and products.",
    copyright: "© 2025 — Allok.fun",
  },
  about: {
    title: "About Allok.fun",
    description: "Pioneering the future of AI-powered brand content for global brands.",
    mission:
      "To create stunning AI-generated visuals that help brands tell their story and connect with their audience.",
    vision: "To be the world's leading AI creative studio, known for innovation, quality, and speed.",
  ...
  pricing: {
    ...
    pro: {
      ...
      features: [
        "Up to 25s AI Video",
        "4 Revisions",
        "Creative Backgrounds, Graphics",
        "Detailed AI Animation",
    ...
    premium: {
      ...
      features: [
        "40–60s AI Video",
        "Creative Backgrounds, Advanced Graphics",
        "Complex AI Effects & Transitions",
        "Advanced Styling, Camera Effects",
        "Priority – 20 Day Turnaround",
        "Highly Complex AI Content Included",
      ],
      videos: [
        "v2AC41dglnM",
        "pRpeEdMmmQ0",
  ...
  orderForm: {
    ...
    modelingOptions: {
      ...
      complex: { price_usd: 120, price_inr: 10000, description: "Advanced compositions, unique art direction" },
    },
    renderOptions: {
    ...
    formSteps: [
      { enabled: true, title: "Package Selection", description: "Choose your video package" },
      { enabled: true, title: "Asset Question", description: "Do you have brand assets? (Pro plan only)" },
      { enabled: true, title: "Content Add-on", description: "Select content complexity (Pro plan only)" },
      { enabled: true, title: "Image Upsell", description: "Add AI images to your order" },
      ...
      <div className="hidden lg:flex w-64 bg-[#0f0f0f] border-r border-neutral-800 flex-col fixed left-0 top-0 h-full z-40">
        ...
        <div className="p-6 border-b border-neutral-800">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-semibold">Allok</span>
          </div>
        </div>
